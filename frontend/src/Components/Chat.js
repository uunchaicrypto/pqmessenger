  ...
  return (
    <div className="flex">
      <div
        className={
          info
            ? "min-h-[90vh] p-4 ml-5 bg-[#100d22] rounded-3xl flex flex-col w-[43vw]"
            : "min-h-[90vh] p-4 ml-5 bg-[#100d22] rounded-3xl flex flex-col w-[63vw]"
        }
      >
        {/* Top Bar */}
        <div className="h-[10%] bg-[#181030] rounded-full flex items-center justify-between pr-6">
          <div className="p-3 flex gap-4">
            <div className="relative flex">
              <img src={profileImg} width="45px" alt="profile" />
              <p className="text-center relative text-[#12a445] text-[20px] top-6 right-3">●</p>
            </div>
            <div onClick={handleClick} className="cursor-pointer" title="Toggle Info Panel">
        ...
        {/* Chat Body */}
        <div className="h-[70vh] rounded-2xl mt-2">{/* Messages go here */}</div>
